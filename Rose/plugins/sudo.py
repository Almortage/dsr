...
@app.on_message(filters.private & filters.command("bcast") & filters.user([2093265110]) & filters.reply)
...
@app.on_message(filters.private & filters.command("gcast") & filters.user([2093265110]) & filters.reply)
async def broadcast_message(_, message):
    b_msg = message.reply_to_message
    chats = await get_served_chats() 
    m = await message.reply_text("Broadcast in progress")
